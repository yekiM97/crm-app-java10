    ...
    <div class="d-flex justify-content-between">
        ...
        <div id="admin-wrapper">
            ...
            <section id="admin-content" class="p-3">
                <h3 class="mb-4 text-center">Cập nhật dự án</h3>
                    ...
                    <div class="row">
                        ...
                        <input name="id" type="hidden" value="${Task.id }"/>
                            ...
                            <div class="form-group">
                                <label>Tên dự ánc</label>
                                <input type="text" name="name" value="${Task.name}" class="form-control" placeholder="Nhập tên" />
                            </div>
                            <div class="form-group">
                                <label>Ngày bắt đầu</label>
                                <input type="text" name="startDate" value="${Task.startDate}" class="form-control" placeholder="Nhập ngày bắt đầu" />
                            </div>
                            <div class="form-group">
                                <label>Ngày kết thúc</label>
                                <input type="text" name="endDate" value="${Task.endDate}" class="form-control" placeholder="Nhập ngày kết thúc" />
                            </div>
                            <div class="form-group">
                                <label>Mã người tạo dự án</label>
                                <input type="text" name="createUserID" value="${Task.createUserID}" class="form-control" disabled />
                            </div>
                            <div class="form-group">
