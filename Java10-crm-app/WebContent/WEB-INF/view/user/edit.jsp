                    ...
                    <p>${message }</p>
                        ...
                        <input name="id" type="hidden" value="${user.id }"/>
                            ...
                            <div class="form-group">
                                ...
                                <input type="password" name="password" value="${user.password }" hidden="true" class="form-control" placeholder="Password" />
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select class="form-control" name="roleId">
                                	...
                                	<c:choose> 
                                		<c:when test="${item.id == user.roleId }"><option value="${item.id}" selected>${item.description}</option></c:when>
                                		<c:otherwise><option value="${item.id}">${item.description}</option></c:otherwise>
                                	</c:choose>
