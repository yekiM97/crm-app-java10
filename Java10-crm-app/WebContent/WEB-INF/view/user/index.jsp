        ...
        <div id="admin-wrapper">
            ...
            <section id="admin-content" class="p-3">
                ...
                <table class="table table-bordered table-hover mt-3">
                    ...
                    <tbody>
                       <c:forEach var="user" items="${User}" varStatus="count">
                        ...
                        <tr>
                            ...
                            <td>${user.role}</td>
                            <td>
                                <a href="<%= request.getContextPath() %>/user/edit?id=${user.id}" class="btn btn-sm btn-info">
                                    <i class="fa fa-pencil-square-o"></i>Edit
                                </a>
                                <a href="<%= request.getContextPath() %>/user/delete?id=${user.id}" class="btn btn-sm btn-danger">
