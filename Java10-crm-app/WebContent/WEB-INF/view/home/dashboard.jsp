...
<head>
    ...
    <link  href="<%= request.getContextPath() %>/assets/css/vendor-flatpickr.css" rel="stylesheet" />
    <link  href="<%= request.getContextPath() %>/assets/css/vendor-flatpickr.rtl.css" rel="stylesheet" />
    <link  href="<%= request.getContextPath() %>/assets/css/vendor-flatpickr-airbnb.css" rel="stylesheet" />
    <link  href="<%= request.getContextPath() %>/assets/css/vendor-flatpickr-airbnb.rtl.css" rel="stylesheet" />
</head>
...
<body>
        ...
        <div class="container page__container">
       	...
       	<!-- Flatpickr -->
		<script src="<%= request.getContextPath() %>/assets/vendor/flatpickr/flatpickr.min.js"></script>
		<script src="<%= request.getContextPath() %>/assets/js/flatpickr.js"></script>
</body>
