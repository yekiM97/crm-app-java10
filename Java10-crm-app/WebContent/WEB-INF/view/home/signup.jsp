...
<body class="layout-login">
    ...
    <div class="layout-login__form bg-white" data-perfect-scrollbar>
		...
		<p>${message }</p>
        <form action="<c:url value="<%=PathConstant.REGISTER %>" />" method="post">
            <div class="form-group">
                <label class="text-label" for="name_2">Name:</label>
                <div class="input-group input-group-merge">
                    <input id="name" type="text" required="" name="name" class="form-control form-control-prepended" placeholder="John Doe">
            ...
            <div class="form-group">
                ...
                <div class="input-group input-group-merge">
                    <input id="password" type="password" required="" name="password" class="form-control form-control-prepended" placeholder="Enter your password">
                    <div class="input-group-prepend">
                        <div class="input-group-text">
            ...
            <div class="form-group text-center">
                ...
                <a class="text-body text-underline" href="<c:url value="<%=PathConstant.HOME_LOGIN %>" />">Have an account? Login</a>
            </div>
        </form>
    </div>
