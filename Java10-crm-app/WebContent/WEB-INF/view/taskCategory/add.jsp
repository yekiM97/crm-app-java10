    ...
    <div class="d-flex justify-content-between">
        ...
        <div id="admin-wrapper">
            ...
            <section id="admin-content" class="p-3">
                ...
                <form method="post" action="<%= request.getContextPath() %>/taskCategory/add">
                    <div class="row">
                        ...
                        <p class="text-danger">${ message }</p>
                            ...
                            <div class="form-group">
                               ...
                               <select name="statusID" class="form-control" data-placeholder="Chọn trạng thái">
                            ...
                            <div class="form-group">
                                ...
                                <a class="btn btn-secondary" href="<%= request.getContextPath() %>/taskCategory">Quay lại</a>
                            </div>
                        </div>
                    </div>
                </form>
